...
Since its creation by the Institut Français du Pétrole (IFP) in 1988,
...
in order to fully illuminate the model and $w$ was increased to assess
changes in resolution. The resulting wavefields visually correlate
with the model and increases in frequency results in increased
resolution. These results agree with physical intuition and the
qualitative tests add more confidence to this manuscripts Helmholtz
implementation.
...
\item sensitivity tests to assess how the wavefield changes with
